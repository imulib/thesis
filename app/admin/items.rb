ActiveAdmin.register Item do
  ...
  #
  # permit_params do
  #   permitted = [:title, :creator, :department, :teatcher_id, :language, :date_submitted, :date_replied, :format_extent_mime, :format_extent_page, :type, :rights_location, :rights_security_classification, :rights_access_rights, :degree_category, :degree_grantor, :degree_descipline, :degree_level]
